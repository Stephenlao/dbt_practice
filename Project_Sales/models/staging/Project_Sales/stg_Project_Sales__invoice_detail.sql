...
select
    ...
    {{ clean_column('Ordered Quantity', 'double') }},
    {{ clean_column('Shipped Quantity', 'double') }},
    {{ clean_column('Invoiced Quantity', 'double') }},
    {{ clean_column('List Price', 'double') }},
    {{ clean_column('Order Price', 'double') }},
    {{ clean_column('Unit Cost', 'double') }},
    {{ clean_column('U/M', 'string' ) }},
    {{ clean_column('Ordered Quantity STD UM', 'double') }},
    {{ clean_column('Shipped Quantity STD UM', 'double') }},
    {{ clean_column('Invoiced Quantity STD UM', 'double') }},
